...
def aplicar_estilo_visual():
    ...
    <style>
        ...
        /* --- BOTÕES DO MENU (DOURADOS COM LETRA PRETA - MANTIDO) --- */
        div[data-testid="column"] .stButton button {
            width: 100% !important;
            height: 240px !important;     /* ALTURA GIGANTE FIXA */
            
            background-color: #C5A065 !important; /* DOURADO */
            color: #1E1B18 !important;            /* PRETO (Legibilidade no Dourado) */
        ...
        /* --- CORREÇÃO DE CORES PARA O RESTO DO SISTEMA (TUDO BRANCO) --- */
        
        /* Força Labels (Nomes dos campos) a serem brancos */
        .stTextInput label, .stSelectbox label, .stDateInput label, .stTimeInput label, .stNumberInput label, .stTextArea label, div[data-testid="stWidgetLabel"] p {
            color: #FFFFFF !important;
        }

        /* Força texto dentro dos Inputs a ser branco */
        ...
        /* Textos gerais (p, span, markdown) brancos */
        .stMarkdown, p, span, h1, h2, h3, h4, h5, h6 {
            color: #FFFFFF !important;
        }
        
        /* Títulos Dourados (Opcional, se preferir títulos dourados, mude para #C5A065) */
        h1, h2, h3 {
...
def tela_menu_principal():
    ...
    # --- ALTERAÇÃO AQUI: COLUNAS PARA APROXIMAR OS BOTÕES ---
    # Antes era [1, 3, 3, 1], mudamos para [2, 3, 3, 2] para empurrar o centro
